        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="mailto:hello@sitesheep.io" className="relative px-5 py-2 text-sm font-semibold text-white rounded-lg overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:bg-amber-600" style={{ background: '#F59E0B' }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50 pt-24 md:pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12">
          <div className="animate-slide-up">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold mb-4 text-gray-900 leading-tight">
              Website Redesign.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            <div className="glass-effect rounded-2xl p-6 md:p-8 text-center hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 gradient-text">237+</div>
            ...
            <div className="glass-effect rounded-2xl p-6 md:p-8 text-center hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 gradient-text">185+</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="process-step text-center">
              <div className="glass-effect rounded-xl p-5 hover:scale-105 transition-transform duration-300 min-h-[220px] flex flex-col justify-between">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-lg md:text-xl font-bold shadow-lg" style={{ background: '#F59E0B' }}>
                  1
                </div>
                <h3 className="text-lg md:text-xl font-bold mb-2 text-gray-900">Submit</h3>
            ...
            <div className="process-step text-center">
              <div className="glass-effect rounded-xl p-5 hover:scale-105 transition-transform duration-300 min-h-[220px] flex flex-col justify-between">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 text-gray-900">Design</h3>
            ...
            <div className="process-step text-center">
              <div className="glass-effect rounded-xl p-5 hover:scale-105 transition-transform duration-300 min-h-[220px] flex flex-col justify-between">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 text-gray-900">Launch</h3>
