  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="absolute -bottom-8 left-20 w-96 h-96 rounded-full filter blur-[120px] opacity-20 animate-float" style={{ background: '#595758', animationDelay: '4s' }}></div>
      ...
      <footer id="contact" className="bg-gradient-to-b from-gray-50 to-white py-12 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-4">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#595758] transition-colors" aria-label="Twitter">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-500">
            <p>&copy; 2024 SiteSheep. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
